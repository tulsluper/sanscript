...
class Switch(models.Model):
    Switch = models.CharField(max_length=30)
    switchName = models.CharField(max_length=4)
    switchType = models.CharField(max_length=4)
    ...
    switchDomain = models.CharField(max_length=2)
...
class Port(models.Model):
    ...
    Comment = models.CharField(max_length=46)
...
class Portshow(models.Model):
    ...
    portFlags = models.CharField(max_length=113)
    ...
    port_generation_number = models.CharField(max_length=4)
    state_transition_count = models.CharField(max_length=3)
...
class Sfp(models.Model):
    ...
    Transceiver = models.CharField(max_length=53)
    ...
    Length_50u_OM3 = models.CharField(max_length=19)
    Length_62u = models.CharField(max_length=19)
    Length_Cu = models.CharField(max_length=17)
    ...
    Pwr_On_Time = models.CharField(max_length=20)
...
class Name(models.Model):
    ...
    FC4s = models.CharField(max_length=8)
    PortSymb = models.CharField(max_length=100)
    NodeSymb = models.CharField(max_length=100)
