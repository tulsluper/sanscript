...
class TPARVV(models.Model):
    ...
    Alert_Adm_Fail = models.CharField(max_length=8)
    Alert_Adm_Fail_Y = models.CharField(max_length=8)
    Alert_Snp_Fail = models.CharField(max_length=8)
    Alert_Snp_Fail_Y = models.CharField(max_length=8)
    Alert_Snp_Lim = models.CharField(max_length=8)
    Alert_Snp_Lim_Y = models.CharField(max_length=8)
    Alert_Snp_Wrn = models.CharField(max_length=8)
    Alert_Snp_Wrn_Y = models.CharField(max_length=8)
    Alert_Usr_Fail = models.CharField(max_length=8)
    Alert_Usr_Fail_Y = models.CharField(max_length=8)
    Alert_Usr_Lim = models.CharField(max_length=8)
    Alert_Usr_Lim_Y = models.CharField(max_length=8)
    Alert_Usr_Wrn = models.CharField(max_length=8)
